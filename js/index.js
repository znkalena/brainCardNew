...
const dataCards={
    ...
    ['заголовок таблицы','th'],['наклонный шрифт','i'],['жирный шрифт','b'],['перенос на другую строку','br'],['формы','form'],['метка','label'],['текстовое поле','textarea'],
    ['выбор цвета','input type="color"'],['выбор даты','input type="date"'],['выбор времени','input type="time"'],
    ['выбор файла','input type="file"'],['выпадающий список','select'],['опция списка','option'],
    ['переключатель','input type="checkbox"'],
...
const dataCardsSecond={
    ...
    ['прозрачность','opacity'],['высота строки','line-height'],['ширина','weight'],['высота','height'],
    ['отступ','padding'],['выравнивание','text-align'],['выравнивание по вертикали','vertical-align'],['тень текста','text-shadow'],['тень блока','box-shadow'],
    ['граница','border'],['скругление углов','border-radius'],['фон картинка','backgraund-image'],
    ['изменить позицию','position'],['относительно родителя','position:relative'],['абсолютное позиционированние','position:absolute'],
    ['фиксированная позиция','position:fixed'],['плавающая позиция','position:float'],['отображение','display']]
};
const initApp = () => {
